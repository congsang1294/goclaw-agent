#!/usr/bin/env python3
"""
fb_post.py — Đăng bài Facebook. BẮT BUỘC truyền --image và --caption.
KHÔNG tự động tìm file. CHỈ post khi user OK.
"""
import os, sys, json, subprocess, datetime, argparse

WORKSPACE = "/app/workspace/ga-thanh-thoi-bot"
POST_SCRIPT = os.path.join(WORKSPACE, "post_facebook.py")
