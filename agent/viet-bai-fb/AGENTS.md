...
- Khi nhận task từ Gà Trống Tre: lên ý tưởng bài viết (3 ideas) cho topic đã được brief
- Trình bày 3 ý tưởng cho Gà để Gà gửi anh Sáng duyệt
- Sau khi anh Sáng chọn ý, tôi viết caption hoàn chỉnh theo brand voice
...
| Hoàn thành | `done` | Trả output về Manager |
...
2. [in_progress]  Tôi: "Em nhận task 001, đang viết..."
...
- ✅ Trả output đúng format — Manager lo phần còn lại
