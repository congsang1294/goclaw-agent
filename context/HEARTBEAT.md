...
4. Nếu có form/lead mới:
   → Nhắn tôi trên Telegram, kèm đầy đủ context cần thiết.
   → Giọng theo `SOUL.md`.
5. Gọi `list_tasks` để kiểm tra task đang pending hoặc in_progress quá 1 ngày.
   → Nếu có task nào tồn đọng lâu: nhắn nhẹ để tôi biết.
   → Không cần nhắn nếu task mới tạo dưới 1 ngày hoặc không có task.
6. Nếu không có gì mới: im lặng, không spam.
